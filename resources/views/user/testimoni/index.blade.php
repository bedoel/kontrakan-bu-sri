...
@section('content')
    ...
    <section class="starter-section section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Testimoni Anda</h2>
            <p>Lihat dan kelola testimoni yang sudah Anda kirim</p>
        </div>
                    ...
                    <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                <a href="{{ route('user.testimoni.edit', $t->id) }}" class="btn btn-sm btn-warning me-2">
                                    Edit
                                </a>
                                <form action="{{ route('user.testimoni.destroy', $t->id) }}" method="POST"
